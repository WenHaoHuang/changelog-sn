...
function getWriterOpts() {
  return {
    finalizeContext: (context, writerOpts, filteredCommits, keyCommit, originalCommits) => {
      ...
      // console.log(writerOpts.transform.toString())
      // console.log(originalCommits)
    ...
    transform: (commit, context) => {
      ...
      if (commit.type === 'refactor' || commit.type === '重构') {
        commit.type = '重构'
        ...
        commit.type = '新功能'
      } else if (commit.type === 'style' || commit.type === '样式') {
        commit.type = '样式'
      } else if (discard) {
        return
